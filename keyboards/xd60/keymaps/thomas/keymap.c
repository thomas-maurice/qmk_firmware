...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN] = LAYOUT_all(
      ...
      KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_PGUP,   KC_TRNS,          KC_ENT, \
      KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,   KC_TRNS, KC_PGUP, KC_INS, \
      KC_LCTL,    KC_LGUI, KC_LALT,                           KC_SPC,                          KC_RGUI, F(0), KC_TRNS, KC_PGDOWN,  KC_TRNS),
};
